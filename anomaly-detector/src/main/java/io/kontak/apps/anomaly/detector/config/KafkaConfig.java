...
public class KafkaConfig {
    ...
    @Bean
    public Function<KStream<String, TemperatureReading>, KStream<String, Anomaly>> anomalyDetectorProcessor(@Qualifier("anomalyDetectorImpl") AnomalyDetector anomalyDetector) {
